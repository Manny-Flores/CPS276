...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mmflores';//this will be your WCC username
      $dbUsr = 'mmflores';//this will be your WCC username
      $dbPass = 'yH8EgWXUwuq9';//this will be the password found in the video.
