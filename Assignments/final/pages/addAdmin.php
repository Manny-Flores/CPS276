    ...
    $pdo = new PdoMethods();
       ...
       if($records == 'error'){
            return getForm("<p>There was a problem processing your form</p>", $elementsArr);
             ...
             return getForm("<p>There is already somebody with that Email!</p>", $elementsArr); 
       }else{
      ...
      if($result == "error"){
        ...
        return getForm("<p>Admin Added</p>", $elementsArr);
      }
    }
...
HTML;
        $acknowledgement = "<h1>Add Admin</h1>".$acknowledgement;
