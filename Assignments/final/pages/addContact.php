...
$elementsArr = [
  ...
  function addData($post){
    ...
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contacts[]" id="emailUpdates" value="emailUpdates" {$elementsArr['contacts']['status']['emailUpdates']}>
      <label class="form-check-label" for="emailUpdates">Email Updates</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="checkbox" name="contacts[]" id="textUpdates" value="textUpdates" {$elementsArr['contacts']['status']['textUpdates']}>
...
HTML;
    $acknowledgement = "<h1>Add Contact</h1>".$acknowledgement;
